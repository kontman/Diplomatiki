...
export default function HostDashboard() {
  ...
  useEffect(() => {
    document.title = 'Dashboard | Ququiz'
  })
  ...
  return (
    <div className="min-h-screen bg-sky-200 dark:bg-sky-800 text-gray-900 dark:text-whitemax-w-3xl">
    <div className="max-w-3xl mx-auto p-6 ">
      ...
      <ul className="space-y-4  ">
        {quizzes.map((quiz) => (
          <li key={quiz.id} className="p-4 rounded-2xl border-gray-500 bg-white/30">
